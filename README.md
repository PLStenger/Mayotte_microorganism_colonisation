...
First, open your terminal. Then, run these two command lines :
    ...
    git clone https://github.com/PLStenger/Mayotte_microorganism_colonisation.git
...
### Run scripts in local by :
    ...
    time nohup bash 10_qiime2_assign_taxonomy_Fungi.sh &> 10_qiime2_assign_taxonomy_Fungi.out
